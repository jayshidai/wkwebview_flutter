...
typedef String OnGetBusinessMsdCallback(String reslut);
...
class WebView extends StatefulWidget {
  ...
  final OnGetBusinessMsdCallback? onGetBusinessMsg;
...
class _PlatformCallbacksHandler implements WebViewPlatformCallbacksHandler {
  ...
  // @override
  // void onGetBusinessMsg(String result) {
  //   if (_widget.onGetBusinessMsg != null) {
  //     return  _widget.onGetBusinessMsg!(result);
  //   }
  // }
  @override
  FutureOr<String> onGetBusinessMsg(String result) {
    if (_widget.onGetBusinessMsg != null) {
      return  _widget.onGetBusinessMsg!(result);
    }
    return '';
